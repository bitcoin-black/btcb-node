...
*/
const char * const BTCB_VERSION_STRING = xstr (TAG_VERSION_STRING);
const char * const BTCB_MAJOR_VERSION_STRING = xstr (MAJOR_VERSION_STRING);
const char * const BTCB_MINOR_VERSION_STRING = xstr (MINOR_VERSION_STRING);
const char * const BTCB_PATCH_VERSION_STRING = xstr (PATCH_VERSION_STRING);
const char * const BTCB_PRE_RELEASE_VERSION_STRING = xstr (PRE_RELEASE_VERSION_STRING);
